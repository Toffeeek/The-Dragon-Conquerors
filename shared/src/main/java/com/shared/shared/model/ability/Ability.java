...
public interface Ability {
     ...
     *
     * <p>Declared rather than hard-coded so class buffs and the
     ...
     * abilities that do not displace. Several heavy attacks use this payload.
     */
     ...
     *
     * <p>Declared rather than detected so cooldown-restoring abilities need no
     ...
     *
     * <p>An ability never resets <em>itself</em>; the resolver enforces that so a
     * future cooldown-restoration ultimate cannot recursively refresh its own
     * cooldown.</p>
     */
