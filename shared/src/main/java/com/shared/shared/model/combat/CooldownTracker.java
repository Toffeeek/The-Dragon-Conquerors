 ...
 *
 * <p>Every ultimate in the game has a cooldown, and several secondary or
 * tertiary abilities do too ({@code Curse} and {@code Battle Focus}, for example). This class owns that
...
public final class CooldownTracker {
     ...
     *
     * <p>This supports any ability that restores a teammate's ultimate cooldown and is
