 ...
 *   <li>Cooldown restoration is {@link Ability#restoresUltimate()}, with one
 *       general guard: an ability may never reset itself.</li>
...
public final class AbilityResolver {
    ...
    /**
     * Clears the target's ultimate cooldown for abilities that request cooldown restoration.
     *
     * <p>Refuses to reset the ability doing the resetting, preventing any future
     * cooldown-restoration ultimate from recursively refreshing itself.</p>
     */
