 ...
 *
 * <p>The current six-class roster keeps six named synergies adapted from the
 * design table. They are deliberately <em>spiky</em>: they stack two steps
...
public final class RaceClassSynergy {
    ...
    /**
     * The six named synergies used by the current roster.
     *
     * <pre>
    ...
    /** True when this pairing is one of the six named roster synergies. */
