...
public final class AbilityOutcome {
    ...
    public static final class TargetResult {
         ...
         *
         * <p>Long-lived stat boosts are applied directly to the stat block and do
         * not require a per-turn status-effect timer.</p>
         */
    ...
    /** True when this action cleared an ally's ultimate cooldown. */
